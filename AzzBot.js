...
let po = zets.prepareMessageFromContent(from, {"listMessage": {"title": title,"description": desc,"buttonText": "Pilih Disini","footerText": "DidinSec 𖤍","listType": "SINGLE_SELECT","sections": list, quoted:mek}}, {})
...
DidinSec 𖤍
⌕ https://github.com/didinsec
⌕ https://youtube.com/shorts/zNm-xhNR-S8?feature=share
...
if (!Number(text)) throw `Example : ${prefix + command} 6281545463585`
...
if (!isCreator) throw mess.owner
zets.public = true
m.reply('Jangan Lupa Join Group DidinBotz‡ https://chat.whatsapp.com/GSZqXilXYMbH5Ou6FBlbJG Terima Kasih><"')
}
break
...
`
var button = [{ buttonId: `tesrow`, buttonText: { displayText: `LIST MENU` }, type: 1 }, { buttonId: `rules`, buttonText: { displayText: `RULES` }, type: 1 }]
...
`
var button = [{ buttonId: `linkgc`, buttonText: { displayText: `GROUP BOT` }, type: 1 }, { buttonId: `owner`, buttonText: { displayText: `OWNER` }, type: 1 }]
zets.sendMessage(m.chat, { caption: `${anu}`, location: { jpegThumbnail: await reSize(buffer, 200, 200) }, buttons: button, footer:  botname, mentions: [m.sender] })
}
break
//────────────────────[ MAIN2 MENU HOOOOOOHHH ]────────────────────
case 'gcmenu': case 'help': case '?': {
addCountCmd(`#${command.slice(1)}`, sender, _cmd)
anu = `Jangan Lupa Join Group DidinBotz‡ https://chat.whatsapp.com/GSZqXilXYMbH5Ou6FBlbJG 👋><`
}
break
//────────────────────[ MAIN2 MENU HOOOOOOHHH ]────────────────────
